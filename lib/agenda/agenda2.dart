...
class AgendaDois extends StatefulWidget {
  AgendaDois({Key key, this.title}) : super(key: key);
  ...
  @override
  _AgendaDoisState createState() => new _AgendaDoisState();
}

class _AgendaDoisState extends State<AgendaDois> {
